...
foreach(test_name ${tests})
	configure_file(${PX4_SOURCE_DIR}/configs/posix-configs/SITL/init/test/tests_template.in ${PX4_SOURCE_DIR}/configs/posix-configs/SITL/init/test/tests_${test_name}_generated)

	add_test(NAME ${test_name}
		COMMAND ${PX4_SOURCE_DIR}/Tools/sitl_run.sh
			$<TARGET_FILE:px4>
			configs/posix-configs/SITL/init/test
			none
			none
...
foreach(cmd_name ${test_cmds})
	configure_file(${PX4_SOURCE_DIR}/configs/posix-configs/SITL/init/test/cmd_template.in ${PX4_SOURCE_DIR}/configs/posix-configs/SITL/init/test/cmd_${cmd_name}_generated)
